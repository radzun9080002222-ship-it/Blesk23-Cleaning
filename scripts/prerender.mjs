...
const routes = {
  ...
  '/uborka-posle-remonta-sochi': {
    ...
    description:
      'Уборка после ремонта в Сочи от 280 ₽/м². Удалим строительную пыль, плёнку, краску и затирку за 1 день. Точная цена в WhatsApp за 2 минуты. Рейтинг 5.0 — 48 отзывов.',
  },
  '/himchistka-mebeli-sochi': {
    title: 'Химчистка мебели в Сочи на дому — от 400 ₽ | Империя Блеска',
    description:
      'Химчистка диванов, кресел, матрасов, ковров и штор в Сочи на дому. Экстракторный метод, сушка 3–6 часов. Безопасно для детей и животных. Рейтинг 5,0 — 48 отзывов.',
  },
  '/uborka-oficov': {
  ...
  '/moyka-okon-sochi': {
    ...
    description:
      'Профессиональная мойка окон в Сочи: квартиры, дома, панорамное остекление, балконы, после ремонта. Без разводов, выезд в день обращения. Рейтинг 5,0 — 48 отзывов.',
  },
};
